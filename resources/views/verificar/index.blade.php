...
<div class="layout-px-spacing mt-4">
    ...
    <div class="row layout-spacing">
        <h2>Solicitudes de vinculación de alumnos -  PENDIENTE</h2>
        <div class="col-12">
            <form action="{{route('verificar.index')}}" method="get">
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-2 col-md-3 col-sm-12 col-12">
                                    <a href="{{route('verificar.verificados')}}" class="btn btn-success btn-md mt-2 ml-2">Verificados</a>
                                </div>
                                <div class="col-xl-2 col-md-3 col-sm-12 col-12">
                                        ...
                                        @foreach ($data as $item) 
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('verificar.aprobar', $item)}}" class="btn btn-outline-success mr-2"><i class="fa-solid fa-check"></i></a>
                                                    <a href="{{route('verificar.rechazar', $item)}}" class="btn btn-outline-danger"><i class="fa-solid fa-ban"></i></a>
                                                </td>
                                            </tr>    
                                        @endforeach                
                                    </tbody>
